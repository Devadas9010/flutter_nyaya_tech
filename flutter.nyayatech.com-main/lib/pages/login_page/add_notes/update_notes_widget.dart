...
class UpdateNotesWidget extends StatefulWidget {
  const UpdateNotesWidget({super.key});
...
class _UpdateNotesWidgetState extends State<UpdateNotesWidget> {
  ...
  void initState() {
    ...
    controller1.text = SharedPrefernce.getnoteTitle();
    controller2.text = SharedPrefernce.getnoteText();
  }
