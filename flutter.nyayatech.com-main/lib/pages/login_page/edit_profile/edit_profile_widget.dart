...
class _EditUserWidgetState extends State<EditUserWidget> {
  ...
  void initState() {
    ...
    selectQulification = SharedPrefernce.getqulification();
    selectoccupation = SharedPrefernce.getoccupation();
    controller7.text = SharedPrefernce.getbio();
    controller8.text = SharedPrefernce.getaaddhar();
    String initialDate = SharedPrefernce.getdateOfBirth();
    if (initialDate.isNotEmpty) {
      DateTime parsedDate = DateTime.parse(initialDate);
      controller6.text = DateFormat('yyyy-MM-dd').format(parsedDate);
    }
        ...
        for (PlatformFile file in result!.files) {
          ...
          try {
            ...
            if (response.statusCode == 200 || response.statusCode == 201) {
              ...
              SharedPrefernce.sets3Url(_model.data!.downloadUrl.toString());
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          await _model.fetchUpdateUser(
                              ...
                              profilePic: SharedPrefernce.getfileKey(),
